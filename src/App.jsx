            ...
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
              <div className="lg:w-2/3 mx-auto">
                <div className="flex flex-wrap w-full bg-gray-800 py-32 px-10 relative mb-4 overflow-hidden">
                  <img alt="gallery" className="hover:scale-105 transition-transform duration-300 w-full object-cover h-full object-center block opacity-25 absolute inset-0" src="src/assets/cover-img1.png" />
                ...
                <div className="flex flex-wrap -mx-2">
                  <div className="px-2 w-1/2">
                    <div className="flex flex-wrap w-full bg-gray-800 sm:py-24 py-16 sm:px-10 px-6 relative overflow-hidden">
                      <img alt="gallery" className="hover:scale-105 transition-transform duration-300 w-full object-cover h-full object-center block opacity-25 absolute inset-0" src="src/assets/cover-img2.png" />
                      <div className="text-center relative z-10 w-full">
                  ...
                  <div className="px-2 w-1/2">
                    <div className="flex flex-wrap w-full bg-gray-800 sm:py-24 py-16 sm:px-10 px-6 relative overflow-hidden">
                      <img alt="gallery" className="hover:scale-105 transition-transform duration-300 w-full object-cover h-full object-center block opacity-25 absolute inset-0" src="src/assets/cover-img3.png" />
                      <div className="text-center relative z-10 w-full">
          ...
          <div className="container flex items-center text-center justify-center flex-col p-5">
            ...
            <span className="mt-5 flex flex-row">
              <a href="https://www.linkedin.com/in/rushi-panchal-b58730239/">
                <img src="src/assets/linkedin-icon.png" alt="linkedIn-icon" className="transition-transform duration-300 transform hover:scale-110 h-20 w-20 m-3" />
              </a>
              <a href="https://www.linkedin.com/in/rushi-panchal-b58730239/">
                <img src="src/assets/x-icon.png" alt="linkedIn-icon" className="transition-transform duration-300 transform hover:scale-110 h-20 w-20 m-3"/>
              </a>
              <a href="https://www.linkedin.com/in/rushi-panchal-b58730239/">
                <img src="src/assets/instagram-icon.png" alt="linkedIn-icon" className="transition-transform duration-300 transform hover:scale-110 h-20 w-20 m-3"/>
              </a>
              <a href="https://www.linkedin.com/in/rushi-panchal-b58730239/">
                <img src="src/assets/github-icon.png" alt="linkedIn-icon" className="transition-transform duration-300 transform hover:scale-110 h-20 w-20 m-3"/>
              </a>
            </span>
          ...
          <div className="bg-black">
            <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
              <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                <img src="src/assets/avtar-bg-yellow.png" alt="logo" viewBox="0 0 24 24" fill="none" className="w-10 h-10 text-white rounded-full" />
              ...
              <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                <a href="mailto:panchalrushi2182004@gmail.com" className="text-gray-500">
                  <img src="src/assets/email-icon.png" alt="logo" viewBox="0 0 24 24" fill="none" className="w-10 h-10 text-white" />
                </a>
              </span>
            </div>
          </div>
